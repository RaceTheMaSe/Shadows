...
if(NOT TOOLCHAIN_PREFIX)
    set(TOOLCHAIN_PREFIX /usr/bin/x86_64-w64-mingw32 CACHE STRING "Toolchain prefix (path to toolchain and architecture)")
endif()
...
# add a variable to toggle some third party builds
get_directory_property(hasParent PARENT_DIRECTORY)
if(hasParent)
  set(IS_A_MINGW_BUILD TRUE PARENT_SCOPE)
else()
  set(IS_A_MINGW_BUILD TRUE)
endif()
